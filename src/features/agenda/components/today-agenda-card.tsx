...
export type TodayAgendaItem = AppointmentPresentationItem;
      ...
      <CardContent className="min-h-0 flex-1 overflow-y-auto p-0 scrollbar-clean">
        {isLoading ? (
          ...
          <>
            <div className="sm:hidden">
              <AppointmentMobileCardsList
                ...
                onAppointmentClick={
                  onAppointmentClick
                    ? (mobileAppointment) => {
                        const appointment = findAppointmentByMobileCardItem(
                          appointments,
                          mobileAppointment,
                        );
            ...
            <ol className="hidden divide-y divide-border/60 sm:block">
