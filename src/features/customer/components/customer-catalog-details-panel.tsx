        ...
        <HintTooltipProvider>
          <div className="mt-4 min-h-0 flex-1 space-y-5 overflow-x-hidden overflow-y-auto pr-1">
            ...
            <DetailSection label="Documento">
              <p className="truncate text-sm text-foreground">{formatCpfCnpj(customer.cpfCnpj)}</p>
              {customer.documentType ? (
                <Badge variant="secondary" className="mt-1 max-w-full truncate font-medium">
                  {customer.documentType}
                </Badge>
              ) : null}
            </DetailSection>
            ...
            <DetailSection label="Endereço">
              <HintTooltip label={formatAddress(customer.address)}>
            ...
            <DetailSection label="Veículo">
              <div className="min-w-0 space-y-1">
                <HintTooltip label={formatVehicleName(primaryVehicle)}>
