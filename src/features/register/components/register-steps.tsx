            ...
            <li className="flex min-w-0 flex-col items-center">
              <span
                className={cn(
                  ...
                  isStepCompleted && "border-[#22C55E]/40 bg-[#22C55E]/15 text-[#86EFAC]",
                  isStepActive &&
              ...
              >
                {isStepCompleted ? <Check aria-hidden className="size-5" /> : index + 1}
              </span>
              <p
                className={cn(
                  "mt-1.5 max-w-20 text-center text-[12px] font-medium leading-tight sm:text-sm",
                  isStepActive || isStepCompleted ? "text-[#F8FAFC]" : "text-[#94A3B8]",
                )}
              >
                {step.label}
              </p>
