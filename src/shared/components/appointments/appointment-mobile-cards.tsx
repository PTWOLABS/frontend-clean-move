    ...
    <HintTooltipProvider>
      <ul className={cn("space-y-3 px-3 pb-4 pt-1 min-[401px]:px-4", className)}>
        {appointments.map((appointment) => {
          ...
          const tooltipTriggerClassName = cn(
            "pointer-events-auto max-w-full min-w-0",
            canOpenAppointment && "cursor-pointer",
          );
          const handleTooltipTriggerClick = canOpenAppointment
                ...
                <div className="grid min-w-0 gap-2 min-[401px]:grid-cols-[minmax(0,1fr)_auto] min-[401px]:items-start">
                  <div className="min-w-0 overflow-hidden">
                    <HintTooltip
                      ...
                      onTriggerClick={handleTooltipTriggerClick}
                    >
                  ...
                  <div className="flex min-w-0 flex-1 items-center gap-2 overflow-hidden min-[401px]:flex-none">
                    <div className="min-w-0 overflow-hidden">
                      <HintTooltip
                        ...
                        onTriggerClick={handleTooltipTriggerClick}
                      >
                        <span className="block min-[401px]:max-w-30 min-[500px]:max-w-50 truncate text-sm font-medium text-foreground">
